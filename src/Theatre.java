...
public class Theatre {
    public static void main(String[] args) {
        ...
        Ballet ballet = new Ballet("Лебединое озеро", 80,director1,new ArrayList<>(),
                new Person("Дмитрий", "Лужин", "мужской"), "Сад перед замком владетельной принцессы. На лужайке " +
                ...
                " выбрать невесту среди девушек, приглашенных на праздник....",new Person("Валентина", "Лучина", "женский"));
        ...
        Opera opera = new Opera("Кармен", 90, director1, new ArrayList<>(),
                new Person("Ксения", "Белова", "женский"), "\"Действие происходит в Испании, в Севилье. Цыганка " +
